...
Steps: 
1. create the new repository called DB-Assignment and make it public and make a file called Answers.md [How to create the repository in gitgub](https://www.geeksforgeeks.org/creating-repository-in-github/)
